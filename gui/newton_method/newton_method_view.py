...
class NewtonMethodView(ctk.CTkFrame):
    """
    Vista placeholder para el Método de Newton (raíces de funciones).
    """
    def __init__(self, master, **kwargs):
        ...
        # Sidebar
        self.sidebar = Sidebar(self, active_method="newton_method")
